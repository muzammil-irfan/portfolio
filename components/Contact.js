  ...
  <>
    ...
    <Stack spacing="8">
      ...
      >
        ...
        <Stack spacing="6" name='contact' method='POST' data-netlify={true}  >
            <Input type='hidden' name='contact' value='contact' />
          <Stack direction={{ base: "column", md: "row" }} spacing={8}>
            <Stack spacing="5" w={{ md: "50%" }}>
              <FormControl>
                <FormLabel htmlFor="name">Name</FormLabel>
                <Input id="name" placeholder='e.g John' name='name' type="text" />
              </FormControl>
            </Stack>
            <Stack spacing="5" w={{ md: "50%" }}>
              <FormControl>
          ...
          <Stack spacing="6" direction={'row'} justify='flex-end'>
            <Button variant="primary" type='submit' bg='gray.200' px={8}>Send</Button>
          </Stack>
        </Stack>
      </Box>
    </Stack>
